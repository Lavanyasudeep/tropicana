...
--
-- Host: localhost
-- Generation Time: Jun 27, 2025 at 05:13 PM
...
CREATE TABLE `cs_payment` (
  ...
  `payment_mode_id` int(50) DEFAULT NULL COMMENT 'cash, transfer, cheque, UPI',
...
--
-- Table structure for table `cs_payment_mode`
--

CREATE TABLE `cs_payment_mode` (
...
--
-- Table structure for table `cs_payment_type_account`
--

CREATE TABLE `cs_payment_type_account` (
  `payment_type_account_id` int(11) NOT NULL,
  `company_id` int(3) NOT NULL,
  `branch_id` int(3) NOT NULL,
  `payment_mode_id` int(2) NOT NULL,
  `payment_mode` varchar(10) NOT NULL,
  `transaction` varchar(10) DEFAULT NULL,
  `rcvd_account_code` varchar(10) NOT NULL,
  `created_by` int(11) DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_by` int(11) DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Indexes for table `cs_payment_mode`
--
ALTER TABLE `cs_payment_mode`
...
--
-- AUTO_INCREMENT for table `cs_payment_mode`
--
ALTER TABLE `cs_payment_mode`
