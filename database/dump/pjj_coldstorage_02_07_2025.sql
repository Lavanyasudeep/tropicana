...
--
-- Host: localhost
-- Generation Time: Jul 02, 2025 at 05:55 AM
...
CREATE TABLE `cs_inward` (
  ...
  `tot_package_qty` double DEFAULT NULL,
...
CREATE TABLE `cs_payment` (
  ...
  `transaction_type` varchar(15) DEFAULT NULL COMMENT 'cash, transfer, cheque, UPI',
  ...
  `supplier_bank` text DEFAULT NULL,
  `supplier_id` int(11) DEFAULT NULL,
  `Remarks` text DEFAULT NULL,
...
CREATE TABLE `GRNDetail` (
  ...
  `OriginalPurchaseRateLC` double DEFAULT NULL,
...
CREATE TABLE `PostOffice` (
  ...
  `Pincode` varchar(50) DEFAULT NULL,
  `RoutePlan` enum('SUN','MON','TUE','WED','THU','FRI','SAT') DEFAULT NULL,
  `CompanyID` int(3) NOT NULL,
...
--
-- AUTO_INCREMENT for table `cs_bank_master`
--
ALTER TABLE `cs_bank_master`
  MODIFY `bank_master_id` int(3) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `PostOffice`
  MODIFY `PostOfficeID` int(11) NOT NULL AUTO_INCREMENT;
...
--
ALTER TABLE `login_logs`
  ADD CONSTRAINT `login_logs_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `cs_users` (`id`);
COMMIT;
