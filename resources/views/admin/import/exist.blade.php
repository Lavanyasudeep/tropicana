...
<script>
    ...
    $(document).ready(function () {
        ...
        const primaryKeys = @json($primaryKeys);
        ...
        // function renderFieldsUI() {
            $('#table-select').on('change', function () {
                ...
                selectedTables.forEach(table => {
                    ...
                    const primary = primaryKeys[table];
                    ...
                    fields.forEach(field => {
                        ...
                        const label = isPrimary ? `<strong>${field}</strong>` : field;

                        checkboxGroup += `<div>
                            <input type="checkbox" class="field-checkbox" data-table="${table}" value="${field}"  ${checked} ${disabled}> ${label}
                        </div>`;
                    });
