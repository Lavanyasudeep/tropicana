  ...
  <div class="section">
    <table class="info-table">
      <tr>
        ...
        <td>: {{$receipt->doc_date}}</td>
      </tr>
      <tr>
        <td class="label">Payee Name</td>
        <td colspan="3">: {{ $receipt->payee?->customer_name?? 'Nil' }}</td>
      </tr>
      <tr>
        <td class="label">Receipt Purpose</td>
        <td colspan="3">: {{ $receipt->purpose?->purpose_name?? 'Nil' }}</td>
      </tr>
      <tr>
        <td class="label">Receipt Mode</td>
        <td colspan="3">: {{ $receipt->transaction_type }}</td>
      </tr>
      <tr>
        <td colspan="4"><br /></td>
      </tr>
      <tr>
        ...
        <td colspan="3" class="amount">: ₹ {{$receipt->paid_amount}}</td>
      </tr>
      <tr>
