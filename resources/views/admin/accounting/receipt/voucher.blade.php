...
<div class="voucher-fixed-panel">
    ...
    <form id="receiptVoucherForm" method="POST" action="{{ route('admin.accounting.receipt.store') }}">
        @csrf
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-2 voucher-form-group">
                        ...
                        <select name="receipt_mode_id" id="receipt_mode_id" class="form-control">
                            <option value="">- Select -</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 voucher-form-group">
                        <label class="voucher-label">Customer Bank</label>
                        <input type="text" class="form-control" name="customer_bank" id="customer_bank" />
                    </div>
                </div>
