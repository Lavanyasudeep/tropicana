                    ...
                    <table class="page-list-table" id="settlementTable">
                        ...
                        <tbody>
                            <tr class="advance_account table-success fw-bold">
                                ...
                                <td>
                                    <input type="hidden" name="settlement[ledger_account][]" value="{{ $payment->to_account_code }}">
                                    {{ $payment->toAccount->account_name }}
                                </td>
                                <td>
                                    <input type="hidden" name="settlement[analytical_code][]" value="{{ $payment->to_analytical_code }}">
                                    {{ $payment->analytical_code }}
                                </td>
                                <td>
                                ...
                                <td class="text-end">
                                    <input type="text" name="settlement[credit][]" value="{{ $payment->requested_amount }}" class="form-control form-control-sm text-end" readonly>
                                </td>
                                <td></td>
                            </tr>
                            ...
                            <tr class="dr_account table-success fw-bold">
                                ...
                                <td>
                                    <input type="hidden" name="settlement[ledger_account][]" value="{{ $payment->from_account_code }}">
                                    {{ $payment->fromAccount->account_name }}
                                </td>
                                <td>
                                    <input type="hidden" name="settlement[analytical_code][]" value="{{ $payment->from_analytical_code }}">
                                    {{ $payment->analytical_code }}
                                </td>
                                <td>
                                    <input type="hidden" name="settlement[narration][]" value="">
                                ...
                                <td class="text-end">
                                    <input type="text" name="settlement[debit][]" value="{{ $payment->requested_amount }}" class="form-control form-control-sm text-end" readonly>
                                </td>
