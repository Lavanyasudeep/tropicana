...
<div class="page-sub-header">
    ...
    <div class="action-btns" >
        <a href="{{ route('admin.inventory.packing-list.edit', $packingList->packing_list_id) }}" class="btn btn-edit"><i class="fas fa-edit"></i> Edit</a>
        <a href="{{ route('admin.inventory.packing-list.print', $packingList->packing_list_id) }}" target="_blank" class="btn btn-primary"><i class="fas fa-print"></i> Print</a>
