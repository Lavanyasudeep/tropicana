...
@section('title', 'Create Pre Alert')
...
<div class="page-sub-header">
    ...
    <div class="action-btns" >
        <a class="btn btn-success" href="{{ route('admin.inventory.pre-alert.index') }}" href="#" ><i class="fas fa-arrow-left"></i> Back</a>
    </div>
</div>

<div class="card page-form page-form-add" >
    <div class="card-body">
        <form method="POST" action="{{ route('admin.inventory.pre-alert.update', $packingList->packing_list_id) }}">
         @csrf
            <div class="row" >
                <!-- Panel 1 -->
                <div class="col-md-3" >
