                                    ...
                                    <table class="page-input-table" id="preAlertItemsTable">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><input type="date" class="form-control mfg" value=""></td>
                                                <td><input type="date" class="form-control exp" value=""></td>
...
function addRow() {
    const table = document.querySelector("#preAlertItemsTable tbody");
