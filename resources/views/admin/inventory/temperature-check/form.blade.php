                ...
                <div class="col-md-4">
                    <div class="pform-panel" style="min-height: 200px;">
                        ...
                        <div class="pform-row">
                            ...
                            <div class="pform-value">
                                <input type="number" id="sku" name="sku" value="">
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="pform-panel" style="min-height: 200px;">
                        ...
                        <div class="pform-row">
                            ...
                            <div class="pform-value">
                                <input type="number" step="0.1" id="vehicle_set_temp" name="vehicle_set_temp" value="">
                            </div>
                        </div>
                        <div class="pform-clear"></div>
                    </div>
                        ...
                        <div class="pform-row">
                            ...
                            <div class="pform-value">
                                <select id="received_by" name="received_by" class="form-control">
                                    ...
                                    <option value="EMP001" >John Mathew</option>
                        ...
                        <div class="pform-row">
                            ...
                            <div class="pform-value">
                                <select id="checked_by" name="checked_by" class="form-control">
                                    <option value="">-- Select Employee --</option>
                                    <option value="EMP004" >Ravi Menon</option>
                        ...
                        <table class="page-input-table" id="temperatureCheckTable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><input name="checks[0][product_temp]" type="number" step="0.1" class="form-control" value=""></td>
