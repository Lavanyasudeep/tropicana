...
class SalesQuotation extends BaseModel
{
    ...
    protected $table = 'cs_sales_quotation';
    ...
    protected static function booted()
    {
        ...
        static::creating(function ($customerEnquiry) {
            ...
            $customerEnquiry->doc_type = $customerEnquiry->doc_type ?? "sales-quotation";
    ...
    {
        return $this->hasMany(SalesQuotationDetail::class, 'sq_id', 'sq_id');
    }
    ...
    {
        return $this->hasMany(StatusUpdate::class, 'row_id', 'sq_id')
