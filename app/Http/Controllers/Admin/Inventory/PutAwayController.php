...
class PutAwayController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.inventory.put-away.index', compact('clients', 'statuses'));
    }
    ...
    {
        return view('admin.inventory.put-away.form');
    }
    ...
    {
        return view('admin.inventory.put-away.view');
    }
    ...
    {
        return view('admin.inventory.put-away.print');
    }
