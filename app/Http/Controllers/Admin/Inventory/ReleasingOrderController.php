...
class ReleasingOrderController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            return DataTables::of($data)
                ...
                ->addColumn('actions', function($res) {
                    $editBtn = '<a href="'.route('admin.inventory.pre-alert.edit', $res->packing_list_id).'" class="btn btn-warning btn-sm" ><i class="fas fa-edit" ></i></a>';

                    $viewBtn = '<a href="'.route('admin.inventory.pre-alert.view', $res->packing_list_id).'" class="btn btn-primary btn-sm">
        ...
        return view('admin.inventory.releasing-order.index', compact('clients'));
    }
    ...
    {
        return view('admin.inventory.releasing-order.form');
    }
    ...
    {
        return view('admin.inventory.releasing-order.view');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        try {
            ...
            return redirect()->route('admin.inventory.pre-alert.index')->with('success', 'Packing List updated successfully.');
        } catch (\Exception $e) {
            DB::rollBack();
    ...
    {
        return view('admin.inventory.releasing-order.print');
    }
