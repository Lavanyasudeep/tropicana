...
class ProductTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
                ...
                ->addColumn('actions', function ($type) {
                    return '
                        <button class="btn btn-sm btn-warning edit-btn" 
                            data-id="' . $type->product_type_id . '" 
                            data-type-name="' . $type->type_name . '" 
                            data-description="' . $type->description . '">
                            <i class="fas fa-edit"></i>
                        </button>
                        <form method="POST" action="' . route('admin.master.general.product-type.destroy', $type->product_type_id) . '" style="display:inline-block;" onsubmit="return confirm(\'Are you sure?\')">
        ...
        return view('admin.master.general.product-type.index');
    }
